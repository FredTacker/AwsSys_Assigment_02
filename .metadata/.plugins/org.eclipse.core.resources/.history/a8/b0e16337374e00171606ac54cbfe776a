...
<html lang="de">
    ...
    <body>
        ...
        <%@ include file="content/includes/navigation.jsp" %>
        ...
        <div class="container">
            <div class="jumbotron">
                ...
                <p><a class="btn btn-primary btn-lg" href="content/imprint.html" role="button">Learn more</a></p>
            </div>
        ...
        <footer class="footer">
            <div class="container">
                <div class="container_footer">
                    <p class="text-muted_footer">@smart-Meter Produzed and Developed by
                        Antonia Steinmann, Franz Tscharf, Henrik Fröhls, Mark Paranski</p>
                </div>
            </div>
        </footer>
